...
namespace Unity.RenderStreaming.Editor
{
    internal class RenderStreamingWizard : EditorWindow
    {
        ...
        const string kTemplatePath = "Assets/ThirdParty/RenderStreaming/Editor/UXML/RenderStreamingWizard.uxml";
        const string kStylePath = "Assets/ThirdParty/RenderStreaming/Editor/Styles/RenderStreamingWizard.uss";
