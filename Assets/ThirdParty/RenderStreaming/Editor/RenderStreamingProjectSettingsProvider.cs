...
namespace Unity.RenderStreaming.Editor
{
    internal class RenderStreamingProjectSettingsProvider : SettingsProvider
    {
        ...
        const string kTemplatePath = "Assets/ThirdParty/RenderStreaming/Editor/UXML/RenderStreamingProjectSettings.uxml";
        const string kStylePath = "Assets/ThirdParty/RenderStreaming/Editor/Styles/RenderStreamingProjectSettings.uss";
